// app/cse_2ndyr_quantumbooks/page.jsx
...
export const metadata = {
    title: "AKTU CSE 2nd Year Quantum Books | Semester 3 & 4 Notes 2024 | AKTU Helper",
    description:
        "Download AKTU BTech CSE 2nd Year Quantum Books for Semester 3 & 4 — Math IV, Data Structure, COA, Python Programming, Cyber Security, TAFL, DSTL, and more. Free PDF download of Quantum Notes for 2024 exams.",
    keywords:
        "AKTU CSE 2nd Year Quantum Books, AKTU Quantum Notes, Data Structure Quantum Book, COA Quantum Notes, Python Programming Quantum Book, Cyber Security Quantum Notes, TAFL Quantum Book, DSTL Quantum Notes, Math IV Quantum Book, AKTU 3rd semester Quantum Books, AKTU 4th semester Quantum Books, AKTU 2024 Quantum Notes free download",
    openGraph: {
        title: "AKTU CSE 2nd Year Quantum Books | Free Semester 3 & 4 Notes",
        description:
            "Get all AKTU BTech CSE 2nd Year Quantum Books for Semester 3 & 4. Boost your exam prep with Quantum Notes — Math IV, Data Structure, COA, Python, TAFL & more.",
        url: "https://aktuhelper.com/cse_2ndyr_quantumbooks",
        siteName: "AKTU Helper",
        type: "website",
    },
    alternates: {
        canonical: "https://aktuhelper.com/cse_2ndyr_quantumbooks",
    },
};
...
const subjects = [
    // Semester 3
    { code: "BAS303", name: "Math IV Quantum Book", shortName: "Math IV Quantum", color: "emerald", href: "/computer_Science/3/math-iv-BAS303/books" },
    { code: "BVE301", name: "UHV(Universal Human Value and Professional Ethics) Quantum Book", shortName: "UHV Quantum", color: "blue", href: "/computer_Science/3/uhvuniversal-human-value-and-professional-ethics-BVE301/books" },
    { code: "BAS301", name: "Technical Communication Quantum Book", shortName: "Technical Comm. Quantum", color: "amber", href: "/computer_Science/3/technical-communication-BAS301/books" },
    { code: "BCS301", name: "Data Structure Quantum Book", shortName: "Data Structure Quantum", color: "violet", href: "/computer_Science/3/data-structure-BCS301/books" },

    // Semester 4
    { code: "BCS302", name: "COA(Computer Organization and Architecture) Quantum Book", shortName: "COA Quantum", color: "cyan", href: "/computer_Science/4/coacomputer-organization-and-architecture-BCS302/books" },
    { code: "BCS303", name: "DSTL Quantum Book", shortName: "DSTL Quantum", color: "rose", href: "/computer_Science/4/dstl-BCS303/books" },
    { code: "BCC302", name: "Python Programming Quantum Book", shortName: "Python Quantum", color: "indigo", href: "/computer_Science/4/python-programming-BCC302/books" },
    { code: "BCC301", name: "Cyber Security Quantum Book", shortName: "Cyber Security Quantum", color: "orange", href: "/computer_Science/4/cyber-security-BCC301/books" },
    { code: "BCS402", name: "TAFL(Theory of Automata and Formal Languages) Quantum Book", shortName: "TAFL Quantum", color: "teal", href: "/computer_Science/4/tafltheory-of-automata-and-formal-languages-BCS402/books" },
];
...
// ── Page Component ─────────────────────────────────────────────────────────────
export default function CSE2ndYearQuantumBooks() {
    return (
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16">
                    <div className="max-w-3xl">
                        ...
                        <div className="inline-flex items-center gap-2 bg-white/10 dark:bg-white/5 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 mb-5">
                            ...
                            <span className="text-sm font-medium text-emerald-100">AKTU · BTech CSE · 2nd Year (Sem 3 & 4)</span>
                        </div>
                        ...
                        <p className="text-lg text-emerald-100 dark:text-emerald-200 leading-relaxed mb-8 max-w-2xl">
                            Download free AKTU BTech CSE 2nd Year Quantum Books for Semester 3 & 4 — Math IV, Data Structures, COA, Python Programming, Cyber Security, DSTL, TAFL, and more. Unit-wise short-answer series for <strong className="text-white">fast revision & exam prep</strong>.
                        </p>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="card-theme p-6 sm:p-8 rounded-2xl mb-10 relative overflow-hidden">
                    ...
                    <div className="relative">
                        <h2 className="text-xl font-bold text-theme-primary mb-3">
                            About AKTU BTech CSE 2nd Year Quantum Books
                        </h2>
                        <p className="text-theme-secondary leading-relaxed text-sm sm:text-base mb-4">
                            Quantum Books (also called Short Books or Quantum Series) are the most popular exam-preparation resource for AKTU BTech students. They provide unit-wise short-answer questions, important long-answer questions, and solved problems strictly aligned with the AKTU syllabus. The 2nd Year Quantum Books cover all core CSE subjects across Semester 3 and Semester 4.
                        </p>
                        <p className="text-theme-secondary leading-relaxed text-sm sm:text-base mb-4">
                            <strong className="text-theme-primary">Semester 3</strong> Quantum Books available for: Engineering Mathematics IV (BAS303), Universal Human Values & Professional Ethics (BVE301), Technical Communication (BAS301), and Data Structures (BCS301).
                        </p>
                        <p className="text-theme-secondary leading-relaxed text-sm sm:text-base mb-4">
                            <strong className="text-theme-primary">Semester 4</strong> Quantum Books available for: Computer Organization & Architecture — COA (BCS302), Discrete Structures & Theory of Logic — DSTL (BCS303), Python Programming (BCC302), Cyber Security (BCC301), and Theory of Automata & Formal Languages — TAFL (BCS402).
                        </p>
                        ...
                        <div className="flex flex-wrap gap-2 mt-5">
                            {["AKTU Quantum 2024", "3rd Semester Notes", "4th Semester Notes", "Data Structure Quantum", "COA Quantum", "Python Quantum", "TAFL Quantum", "DSTL Quantum", "Free PDF", "CSE Branch"].map((tag) => (
                ...
                <section className="mt-16" aria-labelledby="faq-heading">
                    <h2 id="faq-heading" className="text-2xl font-bold text-theme-primary mb-6">
                        Frequently Asked Questions — AKTU CSE 2nd Year Quantum Books
                    </h2>
                    <div className="grid sm:grid-cols-2 gap-4">
                        {[
                            ...
                            {
                                q: "Which subjects have Quantum Books for AKTU CSE 2nd Year (Sem 3 & 4)?",
                                a: "Semester 3 includes Math IV (BAS303), UHV (BVE301), Technical Communication (BAS301), and Data Structures (BCS301). Semester 4 includes COA (BCS302), DSTL (BCS303), Python Programming (BCC302), Cyber Security (BCC301), and TAFL (BCS402).",
                            },
                            {
                ...
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            "@type": "CollectionPage",
                            "name": "AKTU CSE 2nd Year Quantum Books — Semester 3 & 4",
                            "description": "Free download AKTU BTech Computer Science Engineering 2nd Year Quantum Books for Semester 3 & 4, updated for 2024 exams.",
                            "url": "https://aktuhelper.com/cse_2ndyr_quantumbooks",
                            ...
                            "mainEntity": {
                                ...
                                "mainEntity": [
                                    ...
                                    { "@type": "Question", "name": "Which subjects have Quantum Books for AKTU CSE 2nd Year?", "acceptedAnswer": { "@type": "Answer", "text": "Semester 3: Math IV, UHV, Technical Communication, Data Structures. Semester 4: COA, DSTL, Python Programming, Cyber Security, TAFL." } },
                                ],
                            },
                        }),
                    }}
