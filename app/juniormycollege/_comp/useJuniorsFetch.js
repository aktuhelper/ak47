// ✅ Secure useJuniorsFetch hook - uses secure API wrapper
...
const getJuniorYears = (userYear) => {
    ...
    // Normalize year format (handle both "Passout" and "Pass-out")
    ...
    const juniorYears = yearHierarchy[normalizedYear] || [];

    return juniorYears;
};

export default function useJuniorsFetch({
    strapiUser,
    selectedCourse,
    selectedBranch,
    selectedYear,
    ...
    }, [page, fetchJuniors, selectedCourse, strapiUser]);
